...
class ScNN(Model):
    #
    def __init__(self, encoder_layer=[70, 70], latent_size=3, question_size=1, decoder_layer=[70, 70], output_size=1, latent_update=False, beta_rec=500., beta_kl=1., target_var=0.01, activation='elu', **kwargs):
        super().__init__(**kwargs)
        ...
        if self.question_size != 0:
            ...
            if latent_update:
                self.evolve = Evolution(name='evolution_layer')
